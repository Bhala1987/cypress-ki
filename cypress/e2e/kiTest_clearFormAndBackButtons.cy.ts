describe('Ki insurance technical test project - Clear form & Back buttons functionalities', () => {
    ...
    it('Clear form on first page', () => {
        ...
        cy.get('span').contains('This will remove your answers from all questions and cannot be undone.').should('be.visible')
        // And click on "Cancel" button
        cy.xpath('//*[@role="alertdialog"]/div/div[@role="button"]//*[text()="Cancel"]').click()
        // And click on "Clear form" button
        cy.get('span').contains('Clear form').click()
        // And the clear form dialog box should appear
        cy.get('div').contains('Clear form?').should('be.visible')
        ...
        cy.xpath('//*[@role="alertdialog"]/div/div[@role="button"]//*[text()="Clear form"]').click()
