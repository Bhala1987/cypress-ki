describe("Ki insurance technical test project", () => {
  ...
  it("Create a new quote", () => {
    ...
    //Primary Country
    cy.get(
      ':nth-child(2) > [jsmodel="CP1oW"] > .geS5n > .vQES8d > .jgvuAb > [jsname="LgbsSe"] > .ry3kXd > .KKjvXb > .vRMGwf'
    ).dblclick();
    cy.get(
      '[jsmodel="CP1oW"] > .geS5n > .vQES8d > .jgvuAb > [jsname="LgbsSe"] > .ry3kXd > .KKjvXb > .vRMGwf'
    )
      .eq(0)
      .click();
    ...
    //Primary Insured
    cy.get(
      ':nth-child(3) > [jsmodel="CP1oW"] > .geS5n > .vQES8d > .jgvuAb > [jsname="LgbsSe"] > .ry3kXd > .KKjvXb > .vRMGwf'
    ).dblclick();
    cy.get(
      '[jsmodel="CP1oW"] > .geS5n > .vQES8d > .jgvuAb > [jsname="LgbsSe"] > .ry3kXd > .KKjvXb > .vRMGwf'
    )
    ...
    cy.get(".vfQisd")
      .should("exist")
      .contains(
        "Submission completed. Your quote has been created successfully."
      );
    cy.get(".vfQisd")
      .should("exist")
      .contains(
  ...
  it("See my pending quotes", () => {
    ...
    cy.get(".spb5Rd.OIC90c")
      .eq(1)
      .contains("CLASS: Property // PREMIUM: $2.4M");
